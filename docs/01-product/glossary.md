...
| **Flashcard** | A single learning unit with two sides (question/answer or word/translation). |
...
| **Level** | The SRS mastery stage of a flashcard (1–5). Determines the interval until the next Review. |
